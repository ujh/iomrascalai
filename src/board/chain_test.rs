...
fn add_stone_adds_a_stone() {
    ...
    c1.add_stone(Coord::new(14,14), 4);
...
fn merge_adds_all_the_coords_of_the_merged_chain() {
    ...
    c2.add_stone(Coord::new(10,10), 4);
    c2.add_stone(Coord::new(10,11), 3);
    c2.add_stone(Coord::new(11,10), 3);
...
fn merge_doesnt_remove_the_previous_stones() {
    ...
    c1.merge(&c2);
    c1.add_stone(Coord::new(7,7), 4);
    c1.add_stone(Coord::new(7,8), 3);
    c1.add_stone(Coord::new(7,9), 3);
...
fn show_returns_a_legible_string_for_the_chain() {
    ...
    let expected = String::from_str("1| Black, 8 libs: 7,7|7,8|7,9|");
